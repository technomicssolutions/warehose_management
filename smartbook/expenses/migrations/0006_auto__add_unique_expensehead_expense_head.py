...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ExpenseHead', fields ['expense_head']
        db.create_unique(u'expenses_expensehead', ['expense_head'])

    def backwards(self, orm):
        # Removing unique constraint on 'ExpenseHead', fields ['expense_head']
        db.delete_unique(u'expenses_expensehead', ['expense_head'])
