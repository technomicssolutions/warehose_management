...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'expenses_expense', (
            ...
            ('head', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('amount', self.gf('django.db.models.fields.IntegerField')()),
            ('pay_mode', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('expense_head', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('cheque_no', self.gf('django.db.models.fields.IntegerField')()),
            ('cheque_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('bank_name', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ...
        db.create_table(u'expenses_expensehead', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('expense_head', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
    ...
    models = {
        ...
        u'expenses.expense': {
            ...
            'cheque_date': ('django.db.models.fields.DateTimeField', [], {}),
            'cheque_no': ('django.db.models.fields.IntegerField', [], {}),
            'date': ('django.db.models.fields.DateTimeField', [], {}),
            'expense_head': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
