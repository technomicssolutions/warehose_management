...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExpenseHead.expense_head'
        db.alter_column(u'expenses_expensehead', 'expense_head', self.gf('django.db.models.fields.CharField')(unique=True, max_length=75))
    def backwards(self, orm):

        # Changing field 'ExpenseHead.expense_head'
        db.alter_column(u'expenses_expensehead', 'expense_head', self.gf('django.db.models.fields.CharField')(max_length=15, unique=True))
    models = {
        u'auth.group': {
