...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Expense.payment_mode'
        db.alter_column(u'expenses_expense', 'payment_mode', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
    def backwards(self, orm):

        # Changing field 'Expense.payment_mode'
        db.alter_column(u'expenses_expense', 'payment_mode', self.gf('django.db.models.fields.BooleanField')())
    models = {
        u'auth.group': {
