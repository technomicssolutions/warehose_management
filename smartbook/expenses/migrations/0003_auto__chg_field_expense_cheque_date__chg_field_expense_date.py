...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'expenses_expense', 'cheque_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Expense.date'
        db.alter_column(u'expenses_expense', 'date', self.gf('django.db.models.fields.DateField')())
    def backwards(self, orm):

        # Changing field 'Expense.cheque_date'
        db.alter_column(u'expenses_expense', 'cheque_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Expense.date'
        db.alter_column(u'expenses_expense', 'date', self.gf('django.db.models.fields.DateTimeField')())
    models = {
        u'auth.group': {
