...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expense.salesman'
        db.add_column(u'expenses_expense', 'salesman',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Salesman', null=True, to=orm['auth.User']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Expense.salesman'
        db.delete_column(u'expenses_expense', 'salesman_id')
