...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'expenses_expense', 'bank_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Expense.cheque_no'
        db.alter_column(u'expenses_expense', 'cheque_no', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Expense.branch'
        db.alter_column(u'expenses_expense', 'branch', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    def backwards(self, orm):
        ...
        # Changing field 'Expense.cheque_no'
        db.alter_column(u'expenses_expense', 'cheque_no', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        ...
        u'expenses.expense': {
            ...
            'branch': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        u'expenses.expensehead': {
            ...
            'expense_head': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '75'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'purchase.purchase': {
