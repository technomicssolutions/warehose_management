...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Brand.brand'
        db.alter_column(u'inventory_brand', 'brand', self.gf('django.db.models.fields.CharField')(max_length=51))
    def backwards(self, orm):

        # Changing field 'Brand.brand'
        db.alter_column(u'inventory_brand', 'brand', self.gf('django.db.models.fields.CharField')(max_length=50))
    models = {
        u'inventory.brand': {
            'Meta': {'object_name': 'Brand'},
            'brand': ('django.db.models.fields.CharField', [], {'max_length': '51'}),
