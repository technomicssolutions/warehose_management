...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Inventory', fields ['item', 'vendor']
        db.delete_unique(u'inventory_inventory', ['item_id', 'vendor_id'])

        # Deleting field 'Inventory.vendor'
        db.delete_column(u'inventory_inventory', 'vendor_id')

        # Adding unique constraint on 'Inventory', fields ['item']
        db.create_unique(u'inventory_inventory', ['item_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'Inventory', fields ['item']
        db.delete_unique(u'inventory_inventory', ['item_id'])


        # User chose to not deal with backwards NULL issues for 'Inventory.vendor'
        raise RuntimeError("Cannot reverse this migration. 'Inventory.vendor' and its values cannot be restored.")
        # Adding unique constraint on 'Inventory', fields ['item', 'vendor']
        db.create_unique(u'inventory_inventory', ['item_id', 'vendor_id'])
    ...
    models = {
        ...
        u'inventory.openingstock': {
            'Meta': {'unique_together': "(('item', 'vendor'),)", 'object_name': 'OpeningStock'},
            'discount_permit_amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '14', 'decimal_places': '3', 'blank': 'True'}),
            'discount_permit_percentage': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '14', 'decimal_places': '3', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
