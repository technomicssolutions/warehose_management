...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'inventory_item', 'code', self.gf('django.db.models.fields.CharField')(max_length=10))
    def backwards(self, orm):
        ...
        # Changing field 'Item.code'
        db.alter_column(u'inventory_item', 'code', self.gf('django.db.models.fields.IntegerField')())
    models = {
        u'inventory.brand': {
