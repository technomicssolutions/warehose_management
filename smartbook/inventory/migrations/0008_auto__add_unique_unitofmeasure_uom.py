...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UnitOfMeasure', fields ['uom']
        db.create_unique(u'inventory_unitofmeasure', ['uom'])

    def backwards(self, orm):
        # Removing unique constraint on 'UnitOfMeasure', fields ['uom']
        db.delete_unique(u'inventory_unitofmeasure', ['uom'])
