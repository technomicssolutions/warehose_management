...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Designation', fields ['title']
        db.create_unique(u'web_designation', ['title'])

    def backwards(self, orm):
        # Removing unique constraint on 'Designation', fields ['title']
        db.delete_unique(u'web_designation', ['title'])
