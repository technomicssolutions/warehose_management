...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'web_customer', 'customer_id', self.gf('django.db.models.fields.CharField')(default='some@some.com', max_length=75))
    def backwards(self, orm):

        # Changing field 'Customer.customer_id'
        db.alter_column(u'web_customer', 'customer_id', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))
    models = {
        u'auth.group': {
