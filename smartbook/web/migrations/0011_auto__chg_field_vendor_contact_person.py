...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vendor.contact_person'
        db.alter_column(u'web_vendor', 'contact_person', self.gf('django.db.models.fields.CharField')(max_length=50))
    def backwards(self, orm):

        # Changing field 'Vendor.contact_person'
        db.alter_column(u'web_vendor', 'contact_person', self.gf('django.db.models.fields.CharField')(max_length=10))
    models = {
        u'auth.group': {
