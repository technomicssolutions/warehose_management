...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'web_userprofile', 'house_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'UserProfile.district'
        db.alter_column(u'web_userprofile', 'district', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'UserProfile.mobile'
        db.alter_column(u'web_userprofile', 'mobile', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'UserProfile.street'
        db.alter_column(u'web_userprofile', 'street', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'UserProfile.land_line'
        db.alter_column(u'web_userprofile', 'land_line', self.gf('django.db.models.fields.CharField')(max_length=15))
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.mobile'
        db.alter_column(u'web_userprofile', 'mobile', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'UserProfile.street'
        db.alter_column(u'web_userprofile', 'street', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'UserProfile.land_line'
        db.alter_column(u'web_userprofile', 'land_line', self.gf('django.db.models.fields.CharField')(max_length=10))
    models = {
        u'auth.group': {
