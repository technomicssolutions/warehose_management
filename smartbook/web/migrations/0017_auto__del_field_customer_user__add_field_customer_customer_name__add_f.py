...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customer.customer_name'
        db.add_column(u'web_customer', 'customer_name',
        ...
        # Adding field 'Customer.mobile_number'
        db.add_column(u'web_customer', 'mobile_number',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Customer.customer_id'
        db.add_column(u'web_customer', 'customer_id',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Customer.customer_name'
        db.delete_column(u'web_customer', 'customer_name')

        # Deleting field 'Customer.address'
        db.delete_column(u'web_customer', 'address')

        # Deleting field 'Customer.mobile_number'
        db.delete_column(u'web_customer', 'mobile_number')
