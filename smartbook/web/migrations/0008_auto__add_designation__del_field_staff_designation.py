...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Staff.designation'
        raise RuntimeError("Cannot reverse this migration. 'Staff.designation' and its values cannot be restored.")
    models = {
        u'auth.group': {
