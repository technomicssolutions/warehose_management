...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.email_id'
        db.alter_column(u'web_userprofile', 'email_id', self.gf('django.db.models.fields.CharField')(max_length=30))
    def backwards(self, orm):

        # Changing field 'UserProfile.email_id'
        db.alter_column(u'web_userprofile', 'email_id', self.gf('django.db.models.fields.CharField')(max_length=25))
    models = {
        u'auth.group': {
