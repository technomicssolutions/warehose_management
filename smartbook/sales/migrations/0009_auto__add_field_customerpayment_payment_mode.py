...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerPayment.payment_mode'
        db.add_column(u'sales_customerpayment', 'payment_mode',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CustomerPayment.payment_mode'
        db.delete_column(u'sales_customerpayment', 'payment_mode')
