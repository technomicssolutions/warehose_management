...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomerAccount.invoice_no'
        db.alter_column(u'sales_customeraccount', 'invoice_no_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.Sales'], null=True))

        # Changing field 'ReceiptVoucher.sales_invoice'
        db.alter_column(u'sales_receiptvoucher', 'sales_invoice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.Sales'], null=True))
        # Adding field 'Sales.is_processed'
        db.add_column(u'sales_sales', 'is_processed',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CustomerAccount.invoice_no'
        db.alter_column(u'sales_customeraccount', 'invoice_no_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.SalesInvoice'], null=True))

        # Changing field 'ReceiptVoucher.sales_invoice'
        db.alter_column(u'sales_receiptvoucher', 'sales_invoice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.SalesInvoice'], null=True))
        # Deleting field 'Sales.is_processed'
        db.delete_column(u'sales_sales', 'is_processed')
