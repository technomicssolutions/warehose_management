...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReceiptVoucher.settlement_amount'
        db.delete_column(u'sales_receiptvoucher', 'settlement_amount')

        # Deleting field 'ReceiptVoucher.cash'
        db.delete_column(u'sales_receiptvoucher', 'cash')

        # Deleting field 'ReceiptVoucher.amount'
        db.delete_column(u'sales_receiptvoucher', 'amount')

    def backwards(self, orm):
        # Adding field 'ReceiptVoucher.settlement_amount'
        db.add_column(u'sales_receiptvoucher', 'settlement_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'ReceiptVoucher.cash'
        db.add_column(u'sales_receiptvoucher', 'cash',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'ReceiptVoucher.amount'
        db.add_column(u'sales_receiptvoucher', 'amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)
