...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeliveryNoteItem.item'
        db.alter_column(u'sales_deliverynoteitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.InventoryItem'], null=True))

        # Changing field 'SalesReturnItem.item'
        db.alter_column(u'sales_salesreturnitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.InventoryItem'], null=True))

        # Changing field 'SalesItem.item'
        db.alter_column(u'sales_salesitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.InventoryItem']))

        # Changing field 'QuotationItem.item'
        db.alter_column(u'sales_quotationitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.InventoryItem'], null=True))
    def backwards(self, orm):

        # Changing field 'DeliveryNoteItem.item'
        db.alter_column(u'sales_deliverynoteitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Item'], null=True))
        ...
        # Changing field 'SalesItem.item'
        db.alter_column(u'sales_salesitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Item']))

        # Changing field 'QuotationItem.item'
        db.alter_column(u'sales_quotationitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Item'], null=True))
    models = {
        u'auth.group': {
