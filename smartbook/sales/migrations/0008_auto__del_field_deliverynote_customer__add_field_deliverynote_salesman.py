...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeliveryNote.salesman'
        db.add_column(u'sales_deliverynote', 'salesman',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'DeliveryNoteItem.total_quantity'
        db.add_column(u'sales_deliverynoteitem', 'total_quantity',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DeliveryNote.salesman'
        db.delete_column(u'sales_deliverynote', 'salesman_id')

        # Deleting field 'DeliveryNoteItem.total_quantity'
        db.delete_column(u'sales_deliverynoteitem', 'total_quantity')
