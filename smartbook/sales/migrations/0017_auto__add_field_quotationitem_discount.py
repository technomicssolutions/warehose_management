...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuotationItem.discount'
        db.add_column(u'sales_quotationitem', 'discount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=3),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'QuotationItem.discount'
        db.delete_column(u'sales_quotationitem', 'discount')
