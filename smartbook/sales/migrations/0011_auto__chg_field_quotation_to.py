...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quotation.to'
        db.alter_column(u'sales_quotation', 'to_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Customer'], null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Quotation.to'
        raise RuntimeError("Cannot reverse this migration. 'Quotation.to' and its values cannot be restored.")
    models = {
        u'auth.group': {
