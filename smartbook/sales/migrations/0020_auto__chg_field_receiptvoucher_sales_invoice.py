...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ReceiptVoucher.sales_invoice'
        raise RuntimeError("Cannot reverse this migration. 'ReceiptVoucher.sales_invoice' and its values cannot be restored.")
    models = {
        u'auth.group': {
