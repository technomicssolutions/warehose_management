...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sales.sales_invoice_number'
        db.alter_column(u'sales_sales', 'sales_invoice_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    def backwards(self, orm):

        # Changing field 'Sales.sales_invoice_number'
        db.alter_column(u'sales_sales', 'sales_invoice_number', self.gf('django.db.models.fields.IntegerField')())
    models = {
        u'auth.group': {
