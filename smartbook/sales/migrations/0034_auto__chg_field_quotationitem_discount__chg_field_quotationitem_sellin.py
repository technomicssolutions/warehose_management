...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuotationItem.discount'
        db.alter_column(u'sales_quotationitem', 'discount', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))

        # Changing field 'QuotationItem.selling_price'
        db.alter_column(u'sales_quotationitem', 'selling_price', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))
    def backwards(self, orm):

        # Changing field 'QuotationItem.discount'
        db.alter_column(u'sales_quotationitem', 'discount', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=3))

        # Changing field 'QuotationItem.selling_price'
        db.alter_column(u'sales_quotationitem', 'selling_price', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=3))
    models = {
        u'auth.group': {
        ...
        u'sales.salesitem': {
            ...
            'quantity_sold': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'sales': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sales.Sales']"}),
            'selling_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '3'})
        },
        u'sales.salesreturn': {
