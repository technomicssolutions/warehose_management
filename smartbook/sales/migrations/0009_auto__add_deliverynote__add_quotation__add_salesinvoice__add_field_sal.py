...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sales_deliverynote', (
            ...
            ('quotation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.Quotation'])),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Customer'])),
        ...
        db.create_table(u'sales_quotation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Customer'])),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ...
        # Adding M2M table for field item on 'Quotation'
        db.create_table(u'sales_quotation_item', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('quotation', models.ForeignKey(orm[u'sales.quotation'], null=False)),
            ('item', models.ForeignKey(orm[u'inventory.item'], null=False))
        ))
        db.create_unique(u'sales_quotation_item', ['quotation_id', 'item_id'])

        # Adding model 'SalesInvoice'
        db.create_table(u'sales_salesinvoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quotation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.Quotation'])),
            ('delivery_note', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.DeliveryNote'])),
            ...
            ('prefix', self.gf('django.db.models.fields.CharField')(default='SI', max_length=20)),
        ))
        db.send_create_signal(u'sales', ['SalesInvoice'])

        # Adding field 'Sales.quotation'
        db.add_column(u'sales_sales', 'quotation',
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field item on 'Quotation'
        db.delete_table('sales_quotation_item')

        # Deleting model 'SalesInvoice'
        db.delete_table(u'sales_salesinvoice')

        # Deleting field 'Sales.quotation'
        db.delete_column(u'sales_sales', 'quotation_id')
    ...
    models = {
        ...
        u'sales.deliverynote': {
            ...
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Customer']"}),
        ...
        u'sales.quotation': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['inventory.Item']", 'null': 'True', 'blank': 'True'}),
            ...
            'to': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Customer']"})
        },
        u'sales.sales': {
        ...
        u'sales.salesinvoice': {
            ...
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Customer']"}),
            'date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'delivery_note': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sales.DeliveryNote']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
