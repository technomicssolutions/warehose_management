...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sales_customeraccount', (
            ...
            ('invoice_no', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.SalesInvoice'], null=True, blank=True)),
        ...
        # Deleting field 'ReceiptVoucher.prefix'
        db.delete_column(u'sales_receiptvoucher', 'prefix')

        # Deleting field 'ReceiptVoucher.customer'
        db.delete_column(u'sales_receiptvoucher', 'customer_id')

        # Deleting field 'ReceiptVoucher.sum_of'
        db.delete_column(u'sales_receiptvoucher', 'sum_of')

        # Adding field 'ReceiptVoucher.total_amount'
        db.add_column(u'sales_receiptvoucher', 'total_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'ReceiptVoucher.paid_amount'
        db.add_column(u'sales_receiptvoucher', 'paid_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ReceiptVoucher.prefix'
        db.add_column(u'sales_receiptvoucher', 'prefix',
                      self.gf('django.db.models.fields.CharField')(default='RV', max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReceiptVoucher.customer'
        db.add_column(u'sales_receiptvoucher', 'customer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Customer'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReceiptVoucher.sum_of'
        db.add_column(u'sales_receiptvoucher', 'sum_of',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Deleting field 'ReceiptVoucher.total_amount'
        db.delete_column(u'sales_receiptvoucher', 'total_amount')

        # Deleting field 'ReceiptVoucher.paid_amount'
        db.delete_column(u'sales_receiptvoucher', 'paid_amount')
    ...
    models = {
        ...
        u'sales.customeraccount': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_no': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sales.SalesInvoice']", 'null': 'True', 'blank': 'True'}),
