...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sales.discount_for_sale'
        db.add_column(u'sales_sales', 'discount_for_sale',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'Sales.discount_percentage_for_sale'
        db.add_column(u'sales_sales', 'discount_percentage_for_sale',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Sales.discount_for_sale'
        db.delete_column(u'sales_sales', 'discount_for_sale')

        # Deleting field 'Sales.discount_percentage_for_sale'
        db.delete_column(u'sales_sales', 'discount_percentage_for_sale')
