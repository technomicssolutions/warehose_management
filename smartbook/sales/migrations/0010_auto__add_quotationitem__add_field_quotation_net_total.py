...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Quotation.net_total'
        db.add_column(u'sales_quotation', 'net_total',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Quotation.net_total'
        db.delete_column(u'sales_quotation', 'net_total')
