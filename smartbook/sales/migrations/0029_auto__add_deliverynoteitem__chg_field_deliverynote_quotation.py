...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeliveryNote.quotation'
        db.alter_column(u'sales_deliverynote', 'quotation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.Quotation'], null=True))
    def backwards(self, orm):
        # Deleting model 'DeliveryNoteItem'
        db.delete_table(u'sales_deliverynoteitem')


        # User chose to not deal with backwards NULL issues for 'DeliveryNote.quotation'
        raise RuntimeError("Cannot reverse this migration. 'DeliveryNote.quotation' and its values cannot be restored.")
    models = {
        u'auth.group': {
