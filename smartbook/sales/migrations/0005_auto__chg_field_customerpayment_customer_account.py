...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomerPayment.customer_account'
        db.alter_column(u'sales_customerpayment', 'customer_account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.ReceiptVoucher'], null=True))
    def backwards(self, orm):

        # Changing field 'CustomerPayment.customer_account'
        db.alter_column(u'sales_customerpayment', 'customer_account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.CustomerAccount'], null=True))
    models = {
        u'auth.group': {
