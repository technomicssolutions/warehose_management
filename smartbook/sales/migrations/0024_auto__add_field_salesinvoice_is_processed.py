...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SalesInvoice.is_processed'
        db.add_column(u'sales_salesinvoice', 'is_processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SalesInvoice.is_processed'
        db.delete_column(u'sales_salesinvoice', 'is_processed')
