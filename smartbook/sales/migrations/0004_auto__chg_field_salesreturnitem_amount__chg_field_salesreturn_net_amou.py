...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SalesReturnItem.amount'
        db.alter_column(u'sales_salesreturnitem', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))

        # Changing field 'SalesReturn.net_amount'
        db.alter_column(u'sales_salesreturn', 'net_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))
    def backwards(self, orm):

        # Changing field 'SalesReturnItem.amount'
        db.alter_column(u'sales_salesreturnitem', 'amount', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'SalesReturn.net_amount'
        db.alter_column(u'sales_salesreturn', 'net_amount', self.gf('django.db.models.fields.IntegerField')(null=True))
    models = {
        u'auth.group': {
