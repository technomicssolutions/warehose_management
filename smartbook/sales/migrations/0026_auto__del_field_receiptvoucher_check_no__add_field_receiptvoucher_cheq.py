...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReceiptVoucher.check_no'
        db.delete_column(u'sales_receiptvoucher', 'check_no')

        # Adding field 'ReceiptVoucher.cheque_no'
        db.add_column(u'sales_receiptvoucher', 'cheque_no',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'ReceiptVoucher.check_no'
        db.add_column(u'sales_receiptvoucher', 'check_no',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ReceiptVoucher.cheque_no'
        db.delete_column(u'sales_receiptvoucher', 'cheque_no')
