...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeliveryNote.customer'
        db.add_column(u'sales_deliverynote', 'customer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Customer'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'SalesInvoice.customer'
        db.alter_column(u'sales_salesinvoice', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Customer'], null=True))
    def backwards(self, orm):
        # Deleting field 'DeliveryNote.customer'
        db.delete_column(u'sales_deliverynote', 'customer_id')


        # User chose to not deal with backwards NULL issues for 'SalesInvoice.customer'
        raise RuntimeError("Cannot reverse this migration. 'SalesInvoice.customer' and its values cannot be restored.")
    models = {
        u'auth.group': {
