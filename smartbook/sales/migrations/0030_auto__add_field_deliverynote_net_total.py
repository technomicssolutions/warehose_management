...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeliveryNote.net_total'
        db.add_column(u'sales_deliverynote', 'net_total',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'DeliveryNote.net_total'
        db.delete_column(u'sales_deliverynote', 'net_total')
