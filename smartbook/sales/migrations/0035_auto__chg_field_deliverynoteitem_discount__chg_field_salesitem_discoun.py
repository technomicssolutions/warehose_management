...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeliveryNoteItem.discount'
        db.alter_column(u'sales_deliverynoteitem', 'discount', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))

        # Changing field 'SalesItem.discount_given'
        db.alter_column(u'sales_salesitem', 'discount_given', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))

        # Changing field 'SalesItem.selling_price'
        db.alter_column(u'sales_salesitem', 'selling_price', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))

        # Changing field 'Sales.round_off'
        db.alter_column(u'sales_sales', 'round_off', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))

        # Changing field 'Sales.grant_total'
        db.alter_column(u'sales_sales', 'grant_total', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))

        # Changing field 'Sales.discount'
        db.alter_column(u'sales_sales', 'discount', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))

        # Changing field 'Sales.net_amount'
        db.alter_column(u'sales_sales', 'net_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))
    def backwards(self, orm):

        # Changing field 'DeliveryNoteItem.discount'
        db.alter_column(u'sales_deliverynoteitem', 'discount', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=3))

        # Changing field 'SalesItem.discount_given'
        db.alter_column(u'sales_salesitem', 'discount_given', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=3))

        # Changing field 'SalesItem.selling_price'
        db.alter_column(u'sales_salesitem', 'selling_price', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=3))

        # Changing field 'Sales.round_off'
        db.alter_column(u'sales_sales', 'round_off', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=3))

        # Changing field 'Sales.grant_total'
        db.alter_column(u'sales_sales', 'grant_total', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=3))

        # Changing field 'Sales.discount'
        db.alter_column(u'sales_sales', 'discount', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=3))

        # Changing field 'Sales.net_amount'
        db.alter_column(u'sales_sales', 'net_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=3))
    models = {
        u'auth.group': {
        ...
        u'sales.quotation': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'delivery': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_sales_invoice_created': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'net_total': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
            'payment': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'prefix': ('django.db.models.fields.CharField', [], {'default': "'QO'", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'processed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'proof': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            ...
            'validity': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'})
        },
