...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReceiptVoucher.receipt_voucher_no'
        db.add_column(u'sales_receiptvoucher', 'receipt_voucher_no',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ReceiptVoucher.receipt_voucher_no'
        db.delete_column(u'sales_receiptvoucher', 'receipt_voucher_no')
