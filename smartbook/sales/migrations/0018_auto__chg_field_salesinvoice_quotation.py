...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SalesInvoice.quotation'
        db.alter_column(u'sales_salesinvoice', 'quotation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.Quotation'], null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SalesInvoice.quotation'
        raise RuntimeError("Cannot reverse this migration. 'SalesInvoice.quotation' and its values cannot be restored.")
    models = {
        u'auth.group': {
