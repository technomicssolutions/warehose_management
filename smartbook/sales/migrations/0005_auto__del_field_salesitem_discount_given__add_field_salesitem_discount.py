...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SalesItem.discount_given'
        db.delete_column(u'sales_salesitem', 'discount_given')

        # Adding field 'SalesItem.discount_amount'
        db.add_column(u'sales_salesitem', 'discount_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'SalesItem.discount_percentage'
        db.add_column(u'sales_salesitem', 'discount_percentage',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'SalesItem.discount_given'
        db.add_column(u'sales_salesitem', 'discount_given',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Deleting field 'SalesItem.discount_amount'
        db.delete_column(u'sales_salesitem', 'discount_amount')

        # Deleting field 'SalesItem.discount_percentage'
        db.delete_column(u'sales_salesitem', 'discount_percentage')
