...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quotation.validity'
        db.alter_column(u'sales_quotation', 'validity', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Quotation.delivery'
        db.alter_column(u'sales_quotation', 'delivery', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Quotation.proof'
        db.alter_column(u'sales_quotation', 'proof', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Quotation.payment'
        db.alter_column(u'sales_quotation', 'payment', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    def backwards(self, orm):

        # Changing field 'Quotation.validity'
        db.alter_column(u'sales_quotation', 'validity', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Quotation.delivery'
        db.alter_column(u'sales_quotation', 'delivery', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Quotation.proof'
        db.alter_column(u'sales_quotation', 'proof', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Quotation.payment'
        db.alter_column(u'sales_quotation', 'payment', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    models = {
        u'auth.group': {
