...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DeliveryNote', fields ['delivery_note_number']
        db.create_unique(u'sales_deliverynote', ['delivery_note_number'])

        # Adding unique constraint on 'ReceiptVoucher', fields ['receipt_voucher_no']
        db.create_unique(u'sales_receiptvoucher', ['receipt_voucher_no'])

        # Adding unique constraint on 'Sales', fields ['sales_invoice_number']
        db.create_unique(u'sales_sales', ['sales_invoice_number'])

    def backwards(self, orm):
        # Removing unique constraint on 'Sales', fields ['sales_invoice_number']
        db.delete_unique(u'sales_sales', ['sales_invoice_number'])

        # Removing unique constraint on 'ReceiptVoucher', fields ['receipt_voucher_no']
        db.delete_unique(u'sales_receiptvoucher', ['receipt_voucher_no'])

        # Removing unique constraint on 'DeliveryNote', fields ['delivery_note_number']
        db.delete_unique(u'sales_deliverynote', ['delivery_note_number'])
