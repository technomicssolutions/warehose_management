...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'DeliveryNote.customer'
        raise RuntimeError("Cannot reverse this migration. 'DeliveryNote.customer' and its values cannot be restored.")
    models = {
        u'auth.group': {
