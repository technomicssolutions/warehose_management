...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quotation.delivery'
        db.add_column(u'sales_quotation', 'delivery',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Quotation.proof'
        db.add_column(u'sales_quotation', 'proof',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Quotation.Payment'
        db.add_column(u'sales_quotation', 'Payment',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Quotation.validity'
        db.add_column(u'sales_quotation', 'validity',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Quotation.delivery'
        db.delete_column(u'sales_quotation', 'delivery')

        # Deleting field 'Quotation.proof'
        db.delete_column(u'sales_quotation', 'proof')

        # Deleting field 'Quotation.Payment'
        db.delete_column(u'sales_quotation', 'Payment')

        # Deleting field 'Quotation.validity'
        db.delete_column(u'sales_quotation', 'validity')
