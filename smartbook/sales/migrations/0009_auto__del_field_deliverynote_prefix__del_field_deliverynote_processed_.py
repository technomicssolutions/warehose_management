...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DeliveryNote.prefix'
        db.delete_column(u'sales_deliverynote', 'prefix')

        # Deleting field 'DeliveryNote.processed'
        db.delete_column(u'sales_deliverynote', 'processed')

        # Adding field 'DeliveryNote.is_pending'
        db.add_column(u'sales_deliverynote', 'is_pending',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'DeliveryNoteItem.is_completed'
        db.add_column(u'sales_deliverynoteitem', 'is_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'DeliveryNote.prefix'
        db.add_column(u'sales_deliverynote', 'prefix',
                      self.gf('django.db.models.fields.CharField')(default='DN', max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DeliveryNote.processed'
        db.add_column(u'sales_deliverynote', 'processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'DeliveryNote.is_pending'
        db.delete_column(u'sales_deliverynote', 'is_pending')

        # Deleting field 'DeliveryNoteItem.is_completed'
        db.delete_column(u'sales_deliverynoteitem', 'is_completed')
