...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sales_customerpayment', (
            ...
            ('invoice_no', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('customer_account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.CustomerAccount'], null=True, blank=True)),
    ...
    models = {
        ...
        u'sales.customerpayment': {
            ...
            'balance': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
            'customer_account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sales.CustomerAccount']", 'null': 'True', 'blank': 'True'}),
