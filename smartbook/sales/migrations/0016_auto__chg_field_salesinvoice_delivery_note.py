...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SalesInvoice.delivery_note'
        db.alter_column(u'sales_salesinvoice', 'delivery_note_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.DeliveryNote'], null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SalesInvoice.delivery_note'
        raise RuntimeError("Cannot reverse this migration. 'SalesInvoice.delivery_note' and its values cannot be restored.")
    models = {
        u'auth.group': {
