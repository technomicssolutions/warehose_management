...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReceiptVoucher.payment_mode'
        db.add_column(u'sales_receiptvoucher', 'payment_mode',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ReceiptVoucher.payment_mode'
        db.delete_column(u'sales_receiptvoucher', 'payment_mode')
