...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerPayment.amount'
        db.add_column(u'sales_customerpayment', 'amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CustomerPayment.amount'
        db.delete_column(u'sales_customerpayment', 'amount')
