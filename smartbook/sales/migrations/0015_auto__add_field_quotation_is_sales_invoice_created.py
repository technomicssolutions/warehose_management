...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quotation.is_sales_invoice_created'
        db.add_column(u'sales_quotation', 'is_sales_invoice_created',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Quotation.is_sales_invoice_created'
        db.delete_column(u'sales_quotation', 'is_sales_invoice_created')
