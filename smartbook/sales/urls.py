...
urlpatterns = patterns('',
	...
	url(r'^salesman_sales_entry/$', SalesmanSalesEntry.as_view(), name='salesman_sales_entry'),
	url(r'^salesmanstock_items/$', SalesmanStockItemList.as_view(),name='salesmanstock_items_list'),
