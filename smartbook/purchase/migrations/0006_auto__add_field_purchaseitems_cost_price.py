...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseItems.cost_price'
        db.add_column(u'purchase_purchaseitems', 'cost_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=3),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PurchaseItems.cost_price'
        db.delete_column(u'purchase_purchaseitems', 'cost_price')
