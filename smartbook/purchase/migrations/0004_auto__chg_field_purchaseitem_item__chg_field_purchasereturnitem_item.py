...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PurchaseItem.item'
        db.alter_column(u'purchase_purchaseitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.InventoryItem'], null=True))

        # Changing field 'PurchaseReturnItem.item'
        db.alter_column(u'purchase_purchasereturnitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.InventoryItem']))
    def backwards(self, orm):

        # Changing field 'PurchaseItem.item'
        db.alter_column(u'purchase_purchaseitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Item'], null=True))

        # Changing field 'PurchaseReturnItem.item'
        db.alter_column(u'purchase_purchasereturnitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Item']))
    models = {
        u'auth.group': {
