...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VendorAccount.bank_name'
        db.alter_column(u'purchase_vendoraccount', 'bank_name', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'VendorAccount.branch_name'
        db.alter_column(u'purchase_vendoraccount', 'branch_name', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'VendorAccount.cheque_no'
        db.alter_column(u'purchase_vendoraccount', 'cheque_no', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    def backwards(self, orm):

        # Changing field 'VendorAccount.bank_name'
        db.alter_column(u'purchase_vendoraccount', 'bank_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'VendorAccount.branch_name'
        db.alter_column(u'purchase_vendoraccount', 'branch_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'VendorAccount.cheque_no'
        db.alter_column(u'purchase_vendoraccount', 'cheque_no', self.gf('django.db.models.fields.IntegerField')(null=True))
    models = {
        u'auth.group': {
