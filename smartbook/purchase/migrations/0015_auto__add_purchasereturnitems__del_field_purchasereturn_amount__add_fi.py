...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PurchaseReturnItems'
        db.create_table(u'purchase_purchasereturnitems', (
        ...
        db.send_create_signal(u'purchase', ['PurchaseReturnItems'])

        # Deleting field 'PurchaseReturn.amount'
        db.delete_column(u'purchase_purchasereturn', 'amount')

        # Adding field 'PurchaseReturn.net_amount'
        db.add_column(u'purchase_purchasereturn', 'net_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=3),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'PurchaseReturnItems'
        db.delete_table(u'purchase_purchasereturnitems')
        ...
        # Deleting field 'PurchaseReturn.net_amount'
        db.delete_column(u'purchase_purchasereturn', 'net_amount')
    ...
    models = {
        ...
        u'purchase.purchasereturnitems': {
            'Meta': {'object_name': 'PurchaseReturnItems'},
