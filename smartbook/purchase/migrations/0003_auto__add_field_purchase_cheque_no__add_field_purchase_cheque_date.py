...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Purchase.cheque_no'
        db.add_column(u'purchase_purchase', 'cheque_no',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Purchase.cheque_date'
        db.add_column(u'purchase_purchase', 'cheque_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Purchase.cheque_no'
        db.delete_column(u'purchase_purchase', 'cheque_no')

        # Deleting field 'Purchase.cheque_date'
        db.delete_column(u'purchase_purchase', 'cheque_date')
