...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VendorAccountDetail.narration'
        db.add_column(u'purchase_vendoraccountdetail', 'narration',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'VendorAccountDetail.narration'
        db.delete_column(u'purchase_vendoraccountdetail', 'narration')
