...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VendorAccountDetail'
        db.create_table(u'purchase_vendoraccountdetail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vendor_account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.VendorAccount'])),
        ...
        db.send_create_signal(u'purchase', ['VendorAccountDetail'])

    def backwards(self, orm):
        # Deleting model 'VendorAccountDetail'
        db.delete_table(u'purchase_vendoraccountdetail')
