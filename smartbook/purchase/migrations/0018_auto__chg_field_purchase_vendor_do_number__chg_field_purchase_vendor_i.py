...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Purchase.vendor_do_number'
        db.alter_column(u'purchase_purchase', 'vendor_do_number', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Purchase.vendor_invoice_number'
        db.alter_column(u'purchase_purchase', 'vendor_invoice_number', self.gf('django.db.models.fields.CharField')(max_length=10))
    def backwards(self, orm):

        # Changing field 'Purchase.vendor_do_number'
        db.alter_column(u'purchase_purchase', 'vendor_do_number', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Purchase.vendor_invoice_number'
        db.alter_column(u'purchase_purchase', 'vendor_invoice_number', self.gf('django.db.models.fields.IntegerField')())
    models = {
        u'auth.group': {
