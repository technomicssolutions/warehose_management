...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VendorAccount.narration'
        db.alter_column(u'purchase_vendoraccount', 'narration', self.gf('django.db.models.fields.TextField')(null=True))
    def backwards(self, orm):

        # Changing field 'VendorAccount.narration'
        db.alter_column(u'purchase_vendoraccount', 'narration', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    models = {
        u'auth.group': {
