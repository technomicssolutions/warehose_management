...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Purchase', fields ['purchase_invoice_number']
        db.create_unique(u'purchase_purchase', ['purchase_invoice_number'])

    def backwards(self, orm):
        # Removing unique constraint on 'Purchase', fields ['purchase_invoice_number']
        db.delete_unique(u'purchase_purchase', ['purchase_invoice_number'])
