...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Purchase.net_total'
        db.add_column(u'purchase_purchase', 'net_total',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=3),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Purchase.net_total'
        db.delete_column(u'purchase_purchase', 'net_total')
