...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseItems.quantity_purchased'
        db.add_column(u'purchase_purchaseitems', 'quantity_purchased',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PurchaseItems.quantity_purchased'
        db.delete_column(u'purchase_purchaseitems', 'quantity_purchased')
