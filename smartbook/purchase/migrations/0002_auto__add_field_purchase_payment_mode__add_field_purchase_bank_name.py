...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Purchase.payment_mode'
        db.add_column(u'purchase_purchase', 'payment_mode',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Purchase.bank_name'
        db.add_column(u'purchase_purchase', 'bank_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Purchase.payment_mode'
        db.delete_column(u'purchase_purchase', 'payment_mode')

        # Deleting field 'Purchase.bank_name'
        db.delete_column(u'purchase_purchase', 'bank_name')
