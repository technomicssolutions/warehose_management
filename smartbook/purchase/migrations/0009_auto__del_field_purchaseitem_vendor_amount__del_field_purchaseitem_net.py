...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PurchaseItem.vendor_amount'
        db.delete_column(u'purchase_purchaseitem', 'vendor_amount')

        # Deleting field 'PurchaseItem.net_amount'
        db.delete_column(u'purchase_purchaseitem', 'net_amount')

        # Adding field 'Purchase.net_amount'
        db.add_column(u'purchase_purchase', 'net_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=3),
                      keep_default=False)

        # Adding field 'Purchase.vendor_amount'
        db.add_column(u'purchase_purchase', 'vendor_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=3),
                      keep_default=False)

        # Adding field 'Purchase.grant_total'
        db.add_column(u'purchase_purchase', 'grant_total',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=3),
                      keep_default=False)

        # Adding field 'Purchase.purchase_expense'
        db.add_column(u'purchase_purchase', 'purchase_expense',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=3),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'PurchaseItem.vendor_amount'
        db.add_column(u'purchase_purchaseitem', 'vendor_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=3),
                      keep_default=False)

        # Adding field 'PurchaseItem.net_amount'
        db.add_column(u'purchase_purchaseitem', 'net_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=3),
                      keep_default=False)

        # Deleting field 'Purchase.net_amount'
        db.delete_column(u'purchase_purchase', 'net_amount')

        # Deleting field 'Purchase.vendor_amount'
        db.delete_column(u'purchase_purchase', 'vendor_amount')

        # Deleting field 'Purchase.grant_total'
        db.delete_column(u'purchase_purchase', 'grant_total')

        # Deleting field 'Purchase.purchase_expense'
        db.delete_column(u'purchase_purchase', 'purchase_expense')
